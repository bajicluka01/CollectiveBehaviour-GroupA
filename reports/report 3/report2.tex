...
\begin{itemize}
    ...
    \item media (which we omitted in our work, as it is not relevant to our observations): agents attracted to moving in the direction (in their field of view) where the most significant "action" is taking place,
